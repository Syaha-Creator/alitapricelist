...
class _HomeState extends State<Home> {
  ...
  double hitungHargaNet(double originalPrice, double disc1, double disc2,
    ...
    double netPrice = originalPrice;

    // Hitung diskon satu per satu
    if (disc1 > 0) {
      netPrice -= netPrice * disc1; // Diskon 1
    }
    if (disc2 > 0) {
      netPrice -= netPrice * disc2; // Diskon 2
    }
    if (disc3 > 0) {
      netPrice -= netPrice * disc3; // Diskon 3
    }
    if (disc4 > 0) {
      netPrice -= netPrice * disc4; // Diskon 4
    }
    if (disc5 > 0) {
      netPrice -= netPrice * disc5; // Diskon 5
    }
  ...
  void showInputHargaNetPopup(int index, Map<String, String> result) {
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    IconButton(
                                      onPressed: () {
                                        showInputHargaNetPopup(index, result);
                                      },
